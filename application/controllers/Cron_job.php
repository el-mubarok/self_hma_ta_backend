...
class Cron_job extends CI_Controller
{
  ...
  public function userReminder()
  {
    ...
    $session = $this->modelCommon->get(
      TBL_BILLING_SESSION, "MONTH(from_date) = $month AND YEAR(from_date) = $year"
    );
    ...
    if($session) {
      ...
      $reminderTime = $this->modelCommon->get(
        TBL_BILLING_SESSION_TIME, ['billing_session_id' => $session->id], false
      );
