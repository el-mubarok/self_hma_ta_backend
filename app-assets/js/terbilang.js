...
| + output destination, adding three mode (.val(),.html(),.text())
|   for more custom compatibility
*/
...
(function ($) {
  ...
  $.fn.terbilang = function (options) {
    ...
    var readNumbers = function () {
      ...
      var outmode = setting.outmode; // custom from el's
      switch (setting.lang) {
      ...
      if ((sout.search('NaN') != -1) || (sout1.search('NaN') != -1)) {
        ...
        switch (outmode) {
          case 1:
            ...
            break;
          case 2:
            txtout.html(sout + ' ' + sout1);
            break;
          case 3:
            txtout.text(sout + ' ' + sout1);
            break;
        }
      }
    }
